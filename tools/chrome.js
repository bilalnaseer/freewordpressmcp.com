...
const CSS = `
  ...
  * { box-sizing: border-box; }
  ...
  /* Centered reading column: a post's breadcrumb, body and "next" band share
     one 760px column centered in the page, rather than hugging the left of the
     1100px wrap. The blog index keeps the full width for its card grid. */
  .post-page .wrap { max-width: 808px; }
  ...
  .post-cover { width: 100%; border-radius: 12px; display: block; margin: 0 0 40px; }
